...
int main() {
    ...
    do {
        do {
            ...
            int64 ay0 = (a1+x0-1) / x0;
            if(y0<=ay0) continue;
            vector<int64> v2 = {x0,y0-ay0};
            vector<int64> v3 = {b1,c1};
            sort(ALL(v2)),sort(ALL(v3));
            do {
                do {
                    int64 x2 = v2[0];
                    int64 y2 = v2[1];
                    int64 a3 = v3[0];
                    int64 b3 = v3[1];
                    int64 ay2 = (a3+x2-1) / x2;
                    if(y2<=ay2) continue;
                    if(x2 * (y2-ay2) >= b3) flg = true;
