...
constexpr long long MOD_998244352 = MOD_998244353 - 1;
...
int main() {
    ...
    int64 N,K,M; read(N);read(K);read(M);
    corner(M%MOD_998244353==0,0);
    int64 KN = ModInt<MOD_998244352>(K).pow(N).x;
    cout << ModInt<MOD_998244353>(M).pow(KN) << endl;
    return 0;
}
