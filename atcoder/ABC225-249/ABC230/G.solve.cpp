...
// H(6) = h(1) + h(2) + h(3) + h(6)
//      = gcd(f(1),g(1)) + gcd(f(1),g(2)) + ... + gcd(f(6),g(6))
//      = f(1)g(1)/lcm(f(1),g(1)) + f(1)g(2)/lcm(f(1),g(2)) + ... + f(6)g(6)/lcm(f(6),g(6))
//      = f(1){g(1)/lcm(f(1),g(1)) + g(2)/lcm(f(1),g(2)) + ...} + f(2){g(1)/lcm(f(2),g(1)) + ...} + ... + f(6){g(1)/lcm(f(6),g(1)) + ...} 
